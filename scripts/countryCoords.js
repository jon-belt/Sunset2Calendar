const countryCoordinates = {
    //AI generated cos no way im writing this all myself
    ...
    BQ: [12.178361, -68.238534], // Bonaire, Sint Eustatius and Saba
    ...
    GP: [16.265, -61.550999], // Guadeloupe
    ...
    KP: [40.339852, 127.510093], // Korea, North
    ...
    MF: [18.08255, -63.052251], // Saint Martin (French part)
    ...
    SX: [18.04248, -63.05483], // Sint Maarten (Dutch part)
    ...
    SS: [6.876991, 31.306978], // South Sudan
    ...
    VG: [18.420695, -64.639968], // Virgin Islands, British
...
document.getElementById('submit-country').addEventListener('click', function () {
    const selectedCountryCode = document.getElementById('country-dropdown').value;
    const coordinates = countryCoordinates[selectedCountryCode];
...
document.getElementById('search-button').addEventListener('click', function () {
    ...
    if (regex.test(input)) {
        document.getElementById('current-location').innerHTML = input;
        clearError();
    } else {
        showError('Invalid coordinates format. Please use "latitude and longitude separated by a comma".');
    }
});
...
function showError(message) {
    ...
    if (!errorElement) {
        ...
        document.getElementById('coordinates').insertAdjacentElement('afterend', errorDiv);
    }
